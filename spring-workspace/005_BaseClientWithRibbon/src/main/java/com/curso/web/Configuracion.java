...
class HolaMundoClienteController {
	...
	public String home() {
		...
		//.add(new BasicAuthorizationInterceptor("user", "mipassword"));
		
		//Conexion con el servicio hola mundo a traves de Eureka, con el identificador con el que el servicio se regitra en Eureka
		ResponseEntity<String> respuesta = restTemplate.exchange("http://baseclientwithdiscovery", HttpMethod.GET, null, String.class, new Object[]{});
